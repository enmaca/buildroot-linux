...
XBMC_UNDERMEDIA_SITE=./package/thirdparty/xbmc-undermedia/repository.undermedia.addons
...
define XBMC_UNDERMEDIA_INSTALL_STAGING_CMDS
	...
	cp -rf $(@D)/* $(STAGING_DIR)/usr/share/xbmc/addons/repository.undermedia.addons/
endef
